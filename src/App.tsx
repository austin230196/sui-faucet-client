...
import { useGetAirdropRequests, useGetAnalytics } from './api/queries';
...
const SuiFaucetDApp = () => {
  ...
  const [stats, setStats] = useState<{totalRequests: number, totalSuiDistributed: number, activeUsers: number} | null>(null);
  const airdropRequests = useGetAirdropRequests();
